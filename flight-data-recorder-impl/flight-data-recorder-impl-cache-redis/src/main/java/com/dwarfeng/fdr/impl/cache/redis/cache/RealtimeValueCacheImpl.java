...
public class RealtimeValueCacheImpl implements RealtimeValueCache {
    ...
    @Autowired
    private RedisBatchBaseCache<LongIdKey, RealtimeValue, FastJsonRealtimeValue> delegate;
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public RealtimeValue get(LongIdKey key) throws CacheException {
    ...
    public void push(RealtimeValue value, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public List<RealtimeValue> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager")
    public void batchPush(List<RealtimeValue> entities, long timeout) throws CacheException {
