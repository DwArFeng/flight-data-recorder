...
public class CategoryHasChildCacheImpl implements CategoryHasChildCache {
    ...
    @Override
    public List<Category> get(GuidKey key, LookupPagingInfo lookupPagingInfo) throws CacheException {
        return delegate.get(key, lookupPagingInfo);
    }

    @Override
    public void set(GuidKey key, List<? extends Category> value, long timeout) throws CacheException {
        delegate.set(key, value, timeout);
    }

    @Override
    public void push(GuidKey key, List<? extends Category> value, long timeout) throws CacheException {
