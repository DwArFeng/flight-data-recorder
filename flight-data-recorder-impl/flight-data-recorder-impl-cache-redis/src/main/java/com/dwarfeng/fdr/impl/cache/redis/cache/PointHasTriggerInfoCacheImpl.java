...
public class PointHasTriggerInfoCacheImpl implements PointHasTriggerInfoCache {
    ...
    @Override
    public void set(GuidKey key, List<? extends TriggerInfo> value, long timeout) throws CacheException {
        delegate.set(key, value, timeout);
    }

    @Override
    public void push(GuidKey key, List<? extends TriggerInfo> value, long timeout) throws CacheException {
