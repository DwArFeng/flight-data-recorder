...
public class FilteredValueCacheImpl implements FilteredValueCache {
    ...
    @Autowired
    private RedisBatchBaseCache<LongIdKey, FilteredValue, FastJsonFilteredValue> delegate;
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public FilteredValue get(LongIdKey key) throws CacheException {
    ...
    public void push(FilteredValue value, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public List<FilteredValue> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager")
    public void batchPush(List<FilteredValue> entities, long timeout) throws CacheException {
