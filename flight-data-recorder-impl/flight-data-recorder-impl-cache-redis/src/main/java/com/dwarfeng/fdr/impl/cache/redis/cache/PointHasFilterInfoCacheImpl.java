...
public class PointHasFilterInfoCacheImpl implements PointHasFilterInfoCache {
    ...
    @Override
    public List<FilterInfo> get(GuidKey key, LookupPagingInfo lookupPagingInfo) throws CacheException {
        return delegate.get(key, lookupPagingInfo);
    }

    @Override
    public void set(GuidKey key, List<? extends FilterInfo> value, long timeout) throws CacheException {
        delegate.set(key, value, timeout);
    }

    @Override
    public void push(GuidKey key, List<? extends FilterInfo> value, long timeout) throws CacheException {
