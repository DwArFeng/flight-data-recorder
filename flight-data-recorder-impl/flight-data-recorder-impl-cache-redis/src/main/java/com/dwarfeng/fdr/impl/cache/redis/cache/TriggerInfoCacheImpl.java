...
public class TriggerInfoCacheImpl implements TriggerInfoCache {
    ...
    @Autowired
    private RedisBatchBaseCache<LongIdKey, TriggerInfo, FastJsonTriggerInfo> delegate;
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public List<TriggerInfo> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager")
    public void batchPush(List<TriggerInfo> entities, long timeout) throws CacheException {
