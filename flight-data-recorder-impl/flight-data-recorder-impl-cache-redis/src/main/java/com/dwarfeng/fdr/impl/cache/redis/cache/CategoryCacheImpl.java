...
import com.dwarfeng.fdr.sdk.bean.entity.FastJsonCategory;
...
public class CategoryCacheImpl implements CategoryCache {
    ...
    @Autowired
    private RedisBatchBaseCache<LongIdKey, Category, FastJsonCategory> delegate;
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public Category get(LongIdKey key) throws CacheException {
    ...
    public void push(Category value, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true)
    public List<Category> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager")
    public void batchPush(List<Category> entities, long timeout) throws CacheException {
