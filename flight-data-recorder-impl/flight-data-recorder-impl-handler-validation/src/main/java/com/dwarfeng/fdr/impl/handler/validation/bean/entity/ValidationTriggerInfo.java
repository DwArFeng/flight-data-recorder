...
public class ValidationTriggerInfo implements Serializable {
    ...
    public ValidationTriggerInfo(@NonNull @Valid ValidationUuidKey key, @Valid ValidationUuidKey pointKey, boolean enabled, @Length(max = Constants.CONSTRAINT_LENGTH_FILTER_INFO_REMARK) String remark, String content) {
        this.key = key;
