 ...
 */
@Component
public class RangedDoubleFilterRegistry extends AbstractFilterRegistry {

    public static final String FILTER_TYPE = "ranged_double_filter";

    @Autowired
    private ApplicationContext ctx;

    public RangedDoubleFilterRegistry() {
        super(FILTER_TYPE);
    }
    ...
    public String provideExampleContent() {
        return JSON.toJSONString(new RangedDoubleFilterRegistry.Config(
                0.5,
                true,
                -1.25,
                false
    ...
    public String toString() {
        return "RangedDoubleFilterRegistry{" +
                "ctx=" + ctx +
