...
public class RangedDoubleTriggerMaker implements TriggerMaker {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RangedDoubleTriggerMaker.class);
    ...
    public void init() {
        try {
            String label = "具有范围的双精度浮点触发器";
            String description = "如果数据值是双精度浮点数且数值在配置的范围之内，则进行触发。";
