...
public class RangedIntegerFilterMaker implements FilterMaker {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RangedIntegerFilterMaker.class);
    ...
    public void init() {
        try {
            String label = "具有范围的整型过滤器";
            String description = "如果数据值是整型数且数值在配置的范围之内，则通过过滤。";
