package com.dwarfeng.fdr.api.record.dubbo.interceptor;
...
public class DubboInvokeLogAdvisor {
    ...
    @Around("@annotation(com.dwarfeng.fdr.api.record.dubbo.interceptor.DubboInvokeLog) || @within(com.dwarfeng.fdr.api.record.dubbo.interceptor.DubboInvokeLog)")
